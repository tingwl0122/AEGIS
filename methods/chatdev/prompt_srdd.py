...
Phase_configs = {
  ...
  "CodeCompleteAll": {
    ...
    "user_role_name": "Chief Technology Officer",
    "phase_prompt": [
      "According to the new user's task and our current partial implementation listed below:",
      "Task: \"{task}\".",
      "Modality: \"{modality}\".",
      "Programming Language: \"{language}\"",
      "Current Codes:",
      ...
      "As the {assistant_role}, you should complete the implementation for the unimplemented file. The file should be fully functional and integrate properly with the existing codebase.",
      "Provide the complete code for the unimplemented file using the same markdown format as before.",
      "Make sure to:",
      "1. Implement all missing functions and classes",
      "2. Handle edge cases and error conditions", 
      "3. Ensure compatibility with existing code",
      "4. Follow proper coding standards and documentation"
    ]
  },
  "EnvironmentDoc": {
    "assistant_role_name": "Programmer",
